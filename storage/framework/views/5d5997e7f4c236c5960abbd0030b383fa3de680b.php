...
<head>
    ...
    <title>Sistema de Convivências | Página de Registro</title>
    ...
    <div class="register-box-body">
        ...
        <form method="post" action="<?php echo e(url('/register')); ?>">
            ...
            <div class="form-group has-feedback<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                <input type="text" class="form-control" name="name" value="<?php echo e(old('name')); ?>" placeholder="Nome Completo">
        ...
        <a href="<?php echo e(url('/login')); ?>" class="text-center">Eu já tenho cadastro no Sistema</a>
    </div>
    <!-- /.form-box -->
</div>
<!-- /.register-box -->
