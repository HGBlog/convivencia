...
use App\Models\RelatorioTransladoTermino;
use Yajra\DataTables\Services\DataTable;
use Yajra\DataTables\EloquentDataTable;

class RelatorioTransladoTerminoDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'relatorio_translados_termino.datatables_actions');
    }
    ...
    public function query(RelatorioTransladoTermino $model)
    {
        return $model->where('convivencia_id',$this->convivencia )->select('conv.vw_rel_translado_termino.*');
    }
    ...
    protected function getColumns()
    {
        return [
            ...
            'no_local_saida' => ['name' => 'no_local_saida', 'data' => 'no_local_saida', 'title'=>'Local'],
    ...
    {
        return 'relatorio_translados_terminodatatable_' . time();
    }
}