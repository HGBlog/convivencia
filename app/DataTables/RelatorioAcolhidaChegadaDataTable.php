...
class RelatorioAcolhidaChegadaDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'relatorio_acolhidas_chegada.datatables_actions');
    }
    ...
    public function query(RelatorioAcolhidaChegada $model)
    {
        return $model->where('convivencia_id',$this->convivencia )->select('conv.vw_rel_acolhida_chegada.*');
    }
    ...
    {
        return 'relatorio_acolhidas_chegadadatatable_' . time();
    }
}